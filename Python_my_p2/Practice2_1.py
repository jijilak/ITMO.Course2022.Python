...
print(str.title(string1 + string2))
print(str.lower(string1 + string2))
print(str.upper(string1 + string2))
print(str.rstrip(string1 + string2))
print(str.lstrip(string1 + string2))
print(str.strip(string1 + string2))
print(str.strip('This'))
#
# Извлечение символов и подстрок
#
d = "qwerty"
ch = d[2]  # извлекается символ "е"
print(ch)
#
chm = d[1:3], d[0:3] + d[5:6]
print(chm)
chm1 = d[1:], d[:3], d[:], d[1:5:2]
print(chm1)
"""
d[2] = "o"
print(ch)  # TypeError: 'str' object does not support item assignment
"""
#
# Работа с числами
#
...
print(a ** c)  # 36
# param = "string" + 15
# print(param)  # TypeError: can only concatenate str (not "int") to str
#
# Преобразование данных
#
param = "string" + str(15)  # метод конкатенации: преобразовываем число в строку.
print(param)
#
...
#
"""num_1 = float(input("Введите первое число, n1 => "))
num_2 = float(input("Введите второе число, n2 => "))
num_3 = float(num_1) + float(num_2)
print(f"Сумма чисел: {num_1 :.0f} и {num_2 :.0f} равна {num_3 :.0f}")
"""
#
a = 1 / 3
print("{:7.2f}".format(a))
a = 2 / 3
b = 2 / 9
print("{:.1f} {:10.1f}".format(a, b))
print("{:.1e} {:10.1e}".format(a, b))
#
# Списки
#
